...
export const DEFAULT_SETTINGS = {
  ...
  incident_relevance_mode: 2,
  incident_route_buffer_km_relaxed: 12,
  incident_route_buffer_km_strict: 6,
  incident_relaxed_direction_penalty: 0.45,
...
const BOUNDS = {
  ...
  incident_relevance_mode: [0, 2],
  incident_route_buffer_km_relaxed: [1, 60],
  incident_route_buffer_km_strict: [0.5, 40],
  incident_relaxed_direction_penalty: [0, 1],
...
const METHODOLOGY_PRESETS = [
  ...
  },
  {
    ...
    overrides: {
      ...
      incident_relevance_mode: 2,
      incident_route_buffer_km_strict: 5
    }
  },
  {
    id: "cv_vision_fusion",
